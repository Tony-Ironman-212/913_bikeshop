...
function Bike() {
  ...
  useEffect(() => {
    const fetchBikeProducts = async () => {
      try {
        ...
        console.error('Failed to fetch bike products:', err);
      }
    };
    fetchBikeProducts();
  }, []);
  ...
  const filteredProducts = filterProducts(bikeProducts, filter);
    ...
    <div>
      ...
      <div className='mx-auto mt-10 mb-30 flex max-w-[1500px] gap-x-4 px-5'>
        ...
        <div className='flex-1'>
          ...
          <h1 className='mb-2 text-center text-3xl font-bold'>ロードバイク</h1>
